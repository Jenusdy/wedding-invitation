                ...
                <div class="lg:tw-w-4/5 lg:tw-mx-auto">
                    <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 sm:tw-gap-4 md:tw-gap-2 lg:tw-gap-6 tw-mx-auto">
                        <div class="tw-text-center">
                            ...
                            <h2 class="tw-py-3 m-name tw-text-1xl sm:tw-text-lg md:tw-text-1xl lg:tw-text-2xl">Muhammad Vilda Agustian, S.Kom.</h2>
                            {{-- <a href="" class="">@Vildaagustian</a> --}}
                        ...
                        <div class="tw-text-center">
                            ...
                            <h2 class="tw-py-3 m-name tw-text-1xl sm:tw-text-lg md:tw-text-1xl lg:tw-text-2xl">Fawcet Izzatun Nissa, S.Kom.</h2>
                            {{-- <a href="" class="">@zaFawcet</a> --}}
