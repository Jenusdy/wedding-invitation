                ...
                <div id="modal-center" class="uk-flex-top uk-modal" uk-modal="">
                    ...
                    >
                        ...
                        <ul uk-accordion="" class="uk-accordion">
                            <li class="uk-open">
                                <a class="uk-accordion-title" href="#">BRI</a>
                                <div class="uk-accordion-content">
                                    <vue-paycard 
                                        :value-fields="valueFieldsBRI"
                                        :backgroundImage="valueFieldsBRI.backgroundImage"
                                        :is-card-number-masked="false"
                                        :set-type="valueFieldsBRI.cardType" 
                                    />
                                </div>
                            </li>
                            <li class="uk-open">
                                <a class="uk-accordion-title" href="#">BNI</a>
                                <div class="uk-accordion-content">
                                    <vue-paycard 
                                        :value-fields="valueFieldsBNI"
                                        :backgroundImage="valueFieldsBNI.backgroundImage"
                                        :is-card-number-masked="false"
                                        :set-type="valueFieldsBNI.cardType" 
                                    />
                                </div>
                            </li>
                        </ul>
